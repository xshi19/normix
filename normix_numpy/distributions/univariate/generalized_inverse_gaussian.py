...
from normix_numpy.params import GIGParams
from normix_numpy.base import ExponentialFamily
from normix_numpy.utils import log_kv, log_kv_derivative_v, log_kv_derivative_z
...
def _get_gamma():
    ...
    if _gamma_helper is None:
        from normix_numpy.distributions.univariate.gamma import Gamma
        _gamma_helper = Gamma()
...
def _get_invgamma():
    ...
    if _invgamma_helper is None:
        from normix_numpy.distributions.univariate.inverse_gamma import InverseGamma
...
class GeneralizedInverseGaussian(ExponentialFamily):
    ...
    def _get_initial_natural_params(self, eta: NDArray) -> List[NDArray]:
        ...
        """
        from normix_numpy.distributions.univariate.inverse_gaussian import InverseGaussian
