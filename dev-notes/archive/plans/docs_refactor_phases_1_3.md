# Documentation Refactor: MyST + `myst-nb`, internal/external split (Phases 1–3)

> **ARCHIVED — 2026-07-04.** Phases 1–3 (MyST infrastructure + theme, structural
> internal/external split, 18-tutorial tree) are complete and live at
> https://xshi19.github.io/normix/. Kept for historical context: motivation,
> target architecture, visual style, cross-link discipline, and the Phase 1–3
> checklists. The **living plan** for the remaining work (notebook strategy,
> website improvements, release tier, polish) is
> [`../../plans/docs_refactor.md`](../../plans/docs_refactor.md).
