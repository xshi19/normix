...
> `docs/design/exponential_family.md` § 3. ARCHITECTURE.md has the
...
EM time (see `docs/tech_notes/jax_overhead_diagnosis.md` § Resolution).
...
See `docs/tech_notes/gig_eta_to_theta.md` for the derivation, the
...
See `docs/tech_notes/bessel_implementations_survey.md` for benchmarks.
...
- Architecture surface: `docs/ARCHITECTURE.md` § *Bessel Functions*,
  § *GIG η→θ Optimization*.
- Triad design: `docs/design/exponential_family.md`.
- Tech notes: `docs/tech_notes/bessel_implementations_survey.md`,
  `docs/tech_notes/gig_eta_to_theta.md`,
  `docs/tech_notes/em_gpu_profiling.md`,
  `docs/tech_notes/jax_overhead_diagnosis.md`,
  `docs/tech_notes/gig_rvs.md`.
- Historical / archived: `docs/archive/design/solver_redesign.md`,
  `docs/archive/design/log_partition_triad.md`.
