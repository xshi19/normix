...
> `docs/ARCHITECTURE.md` § *Mixture Structure*. EM details are in
> `docs/design/em_framework.md`.
...
- Architecture: `docs/ARCHITECTURE.md` § *Mixture Structure*.
- EM machinery: `docs/design/em_framework.md`.
- Theory: `docs/theory/gh.rst`, `docs/theory/factor_analysis.rst`,
  `docs/theory/shrinkage.rst`.
- Historical / archived rationale: `docs/archive/design/em_covariance_extensions.md`.
